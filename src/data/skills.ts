export const skills = [
  {
    ...
    title: "Security Ops",
    description: "Cyber Threat Hunting (CTH), Information Security, Vulnerability Assessment, and Penetration Testing (VAPT) to identify and mitigate security risks.",
  },
  {
